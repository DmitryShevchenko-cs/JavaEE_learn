<%@ page import="com.Lab6.profile.AccountType" %>
<%@ page import="com.Lab6.profile.ProfileTools" %>
...
<body>
<jsp:useBean id="registeredUser" class="com.Lab6.models.User" scope="session"></jsp:useBean>
